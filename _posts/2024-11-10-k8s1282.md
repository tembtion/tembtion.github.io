...
layout: post
current: post
cover:  /assets/images/posts/2024-11-10-k8s1282/cover.png
navigation: True
...
sudo yum makecache
#安装20.10.16版本
sudo yum install -y docker-ce-20.10.16-3.el9 docker-ce-cli-20.10.16-3.el9 docker-ce-rootless-extras-20.10.16-3.el9 containerd.io docker-compose-plugin
#启动Docker并将其设置成开机自启
